...
[`@aws-sdk/client-iot-managed-integrations`](https://www.npmjs.com/package/@aws-sdk/client-iot-managed-integrations/v/3.1047.0).
...
- @aws-sdk/client-iot-managed-integrations v3.1047.0 - [https://cloud-sdk-builds.github.io/?sdk=client-iot-managed-integrations&version=3.1047.0](https://cloud-sdk-builds.github.io/?sdk=client-iot-managed-integrations&version=3.1047.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot-managed-integrations@3.1047.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0tqOcScEnKWYEfval/fhCOrn93CoK4FJIRVZLOStbiWPaEpBeML9kNgonTFCK+mE
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot-managed-integrations/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iot-managed-integrations": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot-managed-integrations@3.1047.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot-managed-integrations@3.1047.0/index.min.mjs": "sha384-0tqOcScEnKWYEfval/fhCOrn93CoK4FJIRVZLOStbiWPaEpBeML9kNgonTFCK+mE"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-iot-managed-integrations";
...
```
https://github.com/cloud-sdk-builds/client-iot-managed-integrations/blob/refs/tags/3.1047.0/LICENSE
```
